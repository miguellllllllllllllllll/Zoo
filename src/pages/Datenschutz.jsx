    ...
    <main className="datenschutz-wrapper">
      <section>
        ...
        <p>
          ...
          Sicherstellung des Betriebs und dem Schutz vor Angriffen. Die Logfiles
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>Kontaktformular und Feedback-Formular:</strong> Ihr Vor- und
            Nachname und Ihre E-Mail-Adresse
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          ...
          <strong> nicht</strong> für Werbung und
          <strong>grundsätzlich nicht</strong> zur Weitergabe an Dritte, außer:
        </p>
        <ul>
          <li>
            Bei der Bestellung von Bildmaterial teilen wir Ihre Adressdaten dem
            Versanddienstleister mit
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          Zur statistischen Auswertung setzt das Presse- und Informationsamt der
          Bundesregierung (BPA) auf dieser Webseite <em>Matomo</em> (früher
          "PIWIK") ein. Das ist ein Open-Source-Tool zur Web-Analyse. Mit Matomo
          werden keine Daten an Server übermittelt, die außerhalb der Kontrolle
          des BPA liegen (siehe Datenschutzerklärung). Matomo ist deaktiviert,
          wenn Sie unsere Webseite besuchen. Erst wenn Sie aktiv einwilligen,
          wird Ihr Nutzungsverhalten anonymisiert erfasst.
        </p>
        <p>
          ...
          Cookie gewonnenen Informationen über die Nutzung an den Server des BPA
          übertragen und gespeichert, damit das Nutzungsverhalten ausgewertet
          werden kann. Ihre IP-Adresse wird umgehend anonymisiert; damit bleiben
          Sie als Nutzer anonym. Die durch den Cookie erzeugten Informationen
          über Ihre Benutzung dieser Webseite werden nicht an Dritte
          weitergegeben.
        </p>
        <p>
          Das BPA versteht diese Analyse als Bestandteil seines
          Internet-Services. Es möchte damit die Webseite weiter verbessern und
          noch mehr an die Bedürfnisse der Nutzerinnen und Nutzer anpassen.
        </p>
        <p>
